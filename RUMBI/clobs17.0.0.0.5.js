var clobs = ({
	o: { //options
		...
		/**
           ...
           17.0.0.1   02/17 Rough resource timing stats
           ...
           17.0.0.5   06/18 iplcustomdim can now be set as rumbiConf.customdim
           17.0.0.5   06/18 PTQual was not set in stopTimer in Devmod and caused exception 
        */
    ...
    stopTimer:function(e) {
        ...
        try {
            ...
            if (lapsTime > -1) {
            	...
            	clobs.data.iw = false; //image not written -> forces image rewritting
        if (typeof this.PTQual != clobs.o.un){
...
//		this.trace("temps calcul:" + (fin[0] - debut[0]));
	...
	s: function(param /* , ua */ ) { //set : remplit data avec les infos à envoyer
		...
		if (param == 's.ua') { //tous les traitements sur le user agent
			...
			} else if (typeof rumbiConf.customdim != clobs.o.un) this.data.s.custom_level1 = rumbiConf.customdim;
