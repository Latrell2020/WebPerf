...
<label><input id="check1" type="checkbox" name="ny"> New York</label>
<label><input id="check2" type="checkbox" name="bos"> Boston</label>
<label><input id="check3" type="checkbox" name="sfo"> San Francisco</label>
...
<p><a href="PageSlowFirstByte.php" style="font-size:25px;">Link to slow first byte</a></p>
</div> <!-- close content div -->
